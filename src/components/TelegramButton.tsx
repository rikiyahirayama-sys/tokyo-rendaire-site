export default function TelegramButton({
    ...
    const href = `https://t.me/${telegramId}`;
    ...
    if (iconOnly) {
        return (
            <a
                ...
                className="w-12 h-12 rounded-full bg-[#0088cc] hover:bg-[#0077b5] flex items-center justify-center transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105"
                title="Telegram"
            >
